...
//建築物動畫監聽
function go(){
	window.setTimeout("playcrash()",1500);
...
function playcrash(){
	if(sound_on)document.getElementById("crash").play();
}
...
$('#welcome-window #title').fitText(0.8, { minFontSize: '48px', maxFontSize: '92px' });
...
$("#sound").click(function() {
					if(sound_on){
						$(this).attr("src", "img/head/soundoff-01.png");
						document.getElementById("mp3").pause();
						document.getElementById("crash").pause();
					}
					else if(is_start){
						$(this).attr("src", "img/head/soundon-01.png");
						document.getElementById("mp3").play();
					}
					sound_on = !sound_on;
				});
...
$(".optionA").hover(
					function(){
						$(".option-ask").removeClass().addClass('option-ask fadeInUp animated');},
					function(){
						$(".option-ask").removeClass().addClass('option-ask fadeOutDown animated');})
				.click(function() {
...
$(".optionB").hover(
					function(){
						$(".option-noask").removeClass().addClass('option-noask fadeInUp animated');},
					function(){
						$(".option-noask").removeClass().addClass('option-noask fadeOutDown animated');})
				.click(function() {
					$($('.problem')[mission_state]).removeClass().addClass('problem fadeOutDown animated');
					window.setTimeout("gonext()",500);
